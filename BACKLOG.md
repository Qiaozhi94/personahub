...
|----|---------|------|--------|-------|------|
| F001 | 0.1 | Workspace & Issue Foundation | in-progress | TBD | `docs/features/0.1/F001-workspace-issue-foundation/spec.md` |
| F002 | 0.1 | Agent Command Center | review | TBD | `docs/features/0.1/F002-agent-command-center/spec.md` |
| F003 | 0.1 | Development Trace | spec | TBD | `docs/features/0.1/F003-development-trace/spec.md` |
