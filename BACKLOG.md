...
|----|---------|------|--------|-------|------|
| F001 | 0.1 | Workspace & Issue Foundation | spec | TBD | `docs/features/0.1/F001-workspace-issue-foundation/spec.md` |
| F002 | 0.1 | Agent Command Center | spec | TBD | `docs/features/0.1/F002-agent-command-center/spec.md` |
