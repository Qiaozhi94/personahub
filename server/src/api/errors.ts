...
const ERROR_STATUS_MAP: Record<ErrorCode, number> = {
  ...
  [ErrorCode.ARTIFACT_ARCHIVE_WRITE_FAILED]: 500,
  [ErrorCode.ARTIFACT_HASH_MISMATCH]: 409,
  // F013: Space / repository / skill errors
  [ErrorCode.SPACE_NAME_REQUIRED]: 400,
  [ErrorCode.SPACE_NOT_FOUND]: 404,
  [ErrorCode.SPACE_NOT_ACTIVE]: 409,
  [ErrorCode.SPACE_ARCHIVE_BLOCKED]: 409,
  [ErrorCode.ISSUE_SPACE_REQUIRED]: 400,
  [ErrorCode.ISSUE_SPACE_MISMATCH]: 409,
  [ErrorCode.PROJECT_ARCHIVED]: 409,
  [ErrorCode.PROJECT_HAS_REFERENCES]: 409,
  [ErrorCode.REPOSITORY_SOURCE_REQUIRED]: 400,
  [ErrorCode.REPOSITORY_NOT_FOUND]: 404,
  [ErrorCode.REPOSITORY_ALREADY_AUTHORIZED]: 409,
  [ErrorCode.REPOSITORY_CONFLICT]: 409,
  [ErrorCode.REPOSITORY_NOT_AUTHORIZED]: 409,
  [ErrorCode.SCOPE_INVALID_PREFIX]: 400,
  [ErrorCode.SCOPE_WRITE_NOT_IN_READ]: 400,
  [ErrorCode.SKILL_NOT_FOUND]: 404,
  [ErrorCode.SKILL_REVISION_NOT_FOUND]: 404,
  [ErrorCode.SKILL_SCHEMA_INVALID]: 400,
  [ErrorCode.SKILL_SCHEMA_UNKNOWN_FIELD]: 400,
  [ErrorCode.SKILL_EVIDENCE_STATUS_UNKNOWN]: 400,
  [ErrorCode.SKILL_EVIDENCE_STATUS_UNMAPPED]: 400,
  [ErrorCode.SKILL_EVIDENCE_KIND_UNAVAILABLE]: 400,
  [ErrorCode.SKILL_EVIDENCE_CONFLICT]: 400,
  [ErrorCode.SKILL_FILES_TOO_LARGE]: 400,
  [ErrorCode.SKILL_FILE_HASH_MISMATCH]: 500,
  [ErrorCode.SKILL_SOURCE_CONFLICT]: 409,
  [ErrorCode.SKILL_CONFLICT_UNRESOLVED]: 409,
  [ErrorCode.SKILL_SPACE_MISMATCH]: 409,
  [ErrorCode.SKILL_DELIVERY_FAILED]: 409,
  // F012: session / dispatch / intervention errors
  [ErrorCode.ADAPTER_BASE_URL_INVALID]: 400,
  [ErrorCode.ROOM_NOT_FOUND]: 404,
  [ErrorCode.ROOM_ENDED]: 409,
  [ErrorCode.ROOM_ALREADY_TASK_BOUND]: 409,
  [ErrorCode.SPACE_CONTEXT_REQUIRED]: 422,
  [ErrorCode.DISPATCH_NOT_FOUND]: 404,
  [ErrorCode.DISPATCH_NOT_CANCELLABLE]: 409,
  [ErrorCode.DISPATCH_GATE_PAUSED]: 409,
  [ErrorCode.DISPATCH_ACCEPTANCE_LOCKED]: 409,
  [ErrorCode.DISPATCH_IDEMPOTENCY_CONFLICT]: 409,
  [ErrorCode.DISPATCH_GRACE_WINDOW_INVALID]: 400,
  [ErrorCode.ELIGIBILITY_STRUCTURAL_BLOCK]: 422,
  [ErrorCode.ELIGIBILITY_BLOCK_OVERRIDE_REJECTED]: 422,
  [ErrorCode.ATTEMPT_NOT_FOUND]: 404,
  [ErrorCode.ATTEMPT_NOT_ACTIVE]: 409,
  [ErrorCode.GATE_SCOPE_UNKNOWN]: 404,
  [ErrorCode.RUNTIME_CONTEXT_UNAVAILABLE]: 422,
  [ErrorCode.START_LEASE_CONFLICT]: 409,
  [ErrorCode.OUTBOX_TX_REQUIRED]: 500,
  [ErrorCode.OUTBOX_EVENT_NOT_FOUND]: 404,
  [ErrorCode.OUTBOX_NOT_CLAIMED]: 409,
