...
INSERT INTO issues (id, project_id, workspace_id, primary_thread_id, issue_type, workflow_template_id, validation_policy_id, title, goal, status, owner_agent_id, coordinator_agent_id, priority, labels, validation_round_count, blocked_reason_code, blocked_reason_message, validation_dispatch_due_at, created_at, updated_at) VALUES
  ...
  ('iss_v02_graph_blocked', 'prj_v02_alpha', 'ws_v02_alpha', 'thr_v02_graph_blocked', 'coding', 'wft_coding_default', 'vpl_coding_default', 'Split acceptance fixtures', 'Extract shared acceptance fixtures into a reusable module', 'Blocked', NULL, NULL, 'normal', '["acceptance"]', 0, 'node_run_failed', 'Graph blocked: impl node run failed', NULL, '2026-07-02T10:00:00.000Z', '2026-07-02T10:39:10.000Z'),
...
INSERT INTO thread_events (id, event_sequence, thread_id, type, actor_type, actor_id, payload_json, evidence_refs, created_at) VALUES
  ...
  ('evt_g12', 12, 'thr_v02_graph_blocked', 'run.queued', 'system', NULL, '{"run_id":"run_v02_g2_impl_retry","adapter_config_id":"adp_v02_codex_impl"}', '[]', '2026-07-02T10:38:00.000Z');
...
INSERT INTO runs (id, issue_id, thread_id, workspace_id, adapter_config_id, status, failure_reason, instructions, started_at, completed_at, exit_code, error_message, role, workflow_step, validation_round, dispatch_source, final_message, adapter_identity_json, purpose, context_source_run_id, node_run_id, created_at, updated_at) VALUES
  ...
  -- adapter_identity_json is NULL on purpose: this run predates the F004-era
  -- identity snapshots, and a non-null identity would make boot recovery
  -- re-request validation for the still-Running issue (recovery-service).
  ('run_v02_completed', 'iss_v02_running', 'thr_v02_running', 'ws_v02_alpha', 'adp_v02_codex_impl', 'completed', NULL, 'First streaming spike: chunked reader', '2026-07-02T09:00:10.000Z', '2026-07-02T09:15:00.000Z', 0, NULL, 'implementation', 'implementation', NULL, 'user_explicit', NULL, NULL, 'workflow_bound', NULL, NULL, '2026-07-02T09:00:05.000Z', '2026-07-02T09:15:00.000Z'),
  ...
  ('run_v02_running', 'iss_v02_running', 'thr_v02_running', 'ws_v02_alpha', 'adp_v02_codex_impl', 'interrupted', 'server_restarted', 'Third streaming attempt: unbuffered pipe', '2026-07-02T09:30:00.000Z', '2026-07-02T09:40:00.000Z', NULL, 'Server restarted while the run was in flight', 'implementation', 'implementation', NULL, 'user_explicit', NULL, '{"adapter_config_id":"adp_v02_codex_impl","name":"Codex (alpha implementation)","cli_provider":"codex","default_model":null}', 'workflow_bound', 'run_v02_failed', NULL, '2026-07-02T09:29:00.000Z', '2026-07-02T09:30:00.000Z'),
  ('run_v02_g2_impl_retry', 'iss_v02_graph_blocked', 'thr_v02_graph_blocked', 'ws_v02_alpha', 'adp_v02_codex_impl', 'queued', NULL, 'impl retry: split fixtures into a reusable module', NULL, NULL, NULL, NULL, 'graph_node', 'implementation', NULL, 'system', NULL, '{"adapter_config_id":"adp_v02_codex_impl","name":"Codex (alpha implementation)","cli_provider":"codex","default_model":null}', 'workflow_bound', 'run_v02_g2_impl', 'node_v02_g2_impl', '2026-07-02T10:38:00.000Z', '2026-07-02T10:38:00.000Z'),
