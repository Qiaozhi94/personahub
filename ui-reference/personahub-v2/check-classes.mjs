...
for (const file of ["index.html", "code.html", "task.html", "artifact.html"]) {
  ...
  const zones = [
    doc.querySelector("[data-project-explorer]"),
    doc.querySelector("[data-testid='content']"),
    doc.querySelector("[data-right-sidebar-panel='true']"),
    doc.querySelector("body > div.fixed"),
  ].filter(Boolean);
