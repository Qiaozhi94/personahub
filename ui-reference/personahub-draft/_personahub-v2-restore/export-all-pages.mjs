...
await openDocument({ id: "issue-view", explorer: "work", file: "task-and-room.png", title: "任务 · Room 人工介入" });
await openDocument({ id: "artifact-view", explorer: "outputs", file: "artifact-synthesis.png", title: "Artifact · synthesis_plan" });
await openDocument({ id: "artifact-research", explorer: "outputs", file: "artifact-research.png", title: "Artifact · research_findings" });
await openDocument({ id: "evidence-view", explorer: "outputs", file: "evidence-summary.png", title: "Evidence Summary · Graph recovery" });
...
if (exports.length !== 17 || consoleErrors.length) process.exitCode = 1;
