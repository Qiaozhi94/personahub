...
const EVIDENCE_SUMMARY = {
  ...
  implementation_identity: { adapter_config_id: "a", name: "Impl", cli_provider: "codex", default_model: "m", runtime_id: "local" },
  validator_identity: { adapter_config_id: "b", name: "Val", cli_provider: "codex", default_model: "m", runtime_id: "local" },
  policy_id: "p",
  policy_version: 1,
